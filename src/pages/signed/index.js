...
import Poster3 from "@/../../public/images/poster3.jpg";
...
const Signed = React.memo(() => {
  const Table = () => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        ...
        try {
          if (token) {
            // Get the current day in 'Asia/Makassar' timezone
            ...
            if (response.data && response.data.data) {
              ...
              // Log the specific data fields you are interested in
    ...
    return (
      <div className="mx-5 justify-start w-full overflow-hidden max-h-screen">
        <div
          className={`relative overflow-y-auto border-b max-w-[994px] sb-hidden border-gray-300  `}
  ...
  const HeaderInformasi = () => {
    ...
    const getStoredColor2 = () =>
      localStorage.getItem("selectedColor2") || "#AC2427";
    ...
    const determineLabelColor = (backgroundColor) => {
      return chroma.contrast(backgroundColor, "black") >
        chroma.contrast(backgroundColor, "white")
        ? "black"
        : "white";
    };
    ...
    return (
      <table className="w-screen h-full rounded">
        {isModalOpen && (
          <div
            className="fixed left-[650px] top-44 w-full h-full flex items-start justify-start z-3 bg-opacity-50"
            onClick={closeModal}
          >
            <div
              className="bg-white px-10 py-8 border shadow-container rounded-lg text-center"
              onClick={(e) => e.stopPropagation()}
            >
              <div>
                <p className="text-sm">Apakah Anda Ingin Reset</p>
        ...
        <thead className="relative overflow-hidden z-10 rounded-t-lg">
          <tr onClick={openModal}>
            <th
              className="py-2 px-9 sticky top-0 text-center text-white rounded-sm"
              style={{ background: color1, color: labelColor1 }}
            >
              <input
                ref={inputColorRef1}
  ...
  const Announce = () => {
    ...
    return (
      <div>
        ...
        <div
          onClick={openModal}
          className="gap-3 text-center p-2 fixed bottom-0 w-full text-white flex items-center justify-center"
          style={{
            background: color1,
            color: labelColor1,
            height: isFullScreen ? "8vh" : "auto",
          }}
        >
          <FaVolumeUp />
          <input
    ...
    <div>
      ...
      <div className="w-screen h-screen overflow-hidden">
        ...
        <div className="grid grid-cols-4 grid-rows-4">
          ...
          <div className="mr-2">
            <div className="mb-2">{/* <HeaderInformasi /> */}</div>
            <div className="mb-2">{/* <VideoPreview /> */}</div>
            <div className="mb-2">{/* <AkademikCard /> */}</div>
